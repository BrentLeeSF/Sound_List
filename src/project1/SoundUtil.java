...
/*
 * This file was provided by Dr. David Galles to read .wav files into MusicLinkedList, and 
 * is used for playing MusicLinkedList...I wrote a ton of the comments so I could understand exactly 
 * what is happening :) 
 */
...
public class SoundUtil {
	...
	public static void play(MusicList L) throws LineUnavailableException {
		...
		/* Used to iterate through MusicList, takes in array of floats */
	...
	public static MusicLinkedList createSineWave(float time, float frequency, float sampleRate, int numChannels, boolean[] channelsToUse) {
		...
		while (totalTime < time) {
			...
			/* ADDS SAMPLES OF MUSIC TO BE ADDED TO LINKEDLIST NODES on MusicLinkedList file */
			returnVal.addSample(samples);

			/* Ratio of total time of sample time used out of 1 second */
